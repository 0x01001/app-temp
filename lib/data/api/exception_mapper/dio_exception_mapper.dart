    ...
    if (exception is DioException) {
      switch (exception.type) {
        ...
        case DioExceptionType.badResponse:
          ...
          if (httpErrorCode == HttpStatus.serviceUnavailable) {
            return RemoteException(kind: RemoteExceptionKind.serverMaintenance, httpErrorCode: httpErrorCode, rootException: exception);
          }
          ...
          if (exception.response?.data != null) {
            ...
            return RemoteException(kind: RemoteExceptionKind.serverDefined, httpErrorCode: httpErrorCode, serverError: serverError);
          }

          return RemoteException(kind: RemoteExceptionKind.serverUndefined, httpErrorCode: httpErrorCode, rootException: exception);
        case DioExceptionType.badCertificate:
          return RemoteException(kind: RemoteExceptionKind.badCertificate, rootException: exception);
