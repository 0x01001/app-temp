...
class FirebaseAuthService {
  ...
  Future<String> signInWithEmailAndPassword({required String email, required String password}) async {
    try {
      ...
      Log.e('FirebaseAuthService > signInWithEmailAndPassword > error: ${e.code} - ${e.message}');
      switch (e.code) {
        case 'invalid-email':
          throw AppFirebaseAuthException(kind: AppFirebaseAuthExceptionKind.invalidEmail);
        default:
          throw AppFirebaseAuthException(kind: AppFirebaseAuthExceptionKind.invalidLoginCredentials);
      }
    }
  }
    ...
    try {
      ...
      switch (e.code) {
        case 'email-already-in-use':
          throw AppFirebaseAuthException(kind: AppFirebaseAuthExceptionKind.usernameAlreadyInUse);
        default:
          throw AppFirebaseAuthException(kind: AppFirebaseAuthExceptionKind.unknown);
      }
    }
  }
