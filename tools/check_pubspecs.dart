...
void main() {
  ...
  final invalidDependencyOverrides = dependencyOverrides.filter((entry) => isInvalidPub(entry.value));
  ...
  exit(invalidDependencies.isNotEmpty || invalidDevDependencies.isNotEmpty || invalidDependencyOverrides.isNotEmpty ? 1 : 0);
}

bool isInvalidPub(dynamic pubVersion) {
  return pubVersion == null || pubVersion is String && (pubVersion.trim() == 'any' || pubVersion.isBlank || pubVersion.startsWith('^'));
}
