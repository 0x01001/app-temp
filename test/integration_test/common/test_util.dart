...
extension WidgetTesterExtension on WidgetTester {
    ...
    Future.doWhile(() async {
      ...
      await Future.delayed(
        ...
        () async {
          await pump();
          afterTime = Duration(
            milliseconds: afterTime.inMilliseconds > delayMillisecond ? afterTime.inMilliseconds - delayMillisecond : 0,
          );
        },
      );
  ...
  Future<void> _takeScreenshotForAndroid({
    ...
    final rawBytes = await integrationTestChannel.invokeMethod<List<int>>('captureScreenshot', <String, dynamic>{'name': fileName});
