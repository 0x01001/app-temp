...
part of 'package:app_interactive_list/src/components/widgets/scrollable.dart';
...
class ScrollAction extends ContextAction<ScrollIntent> {
  ...
  void invoke(ScrollIntent intent, [BuildContext? context]) {
    ...
    if (state == null) {
      ...
      if (primaryScrollController.position.context.notificationContext == null && Scrollable.maybeOf(primaryScrollController.position.context.notificationContext!) == null) {
        return;
      }
